...
{
    public class EventTypeManagerController : Controller
    {
        private FinalProjectDbContext db = new FinalProjectDbContext();

        // GET: EventTypeManager
        public ActionResult Index()
        {
            return View(db.EventTypes.ToList());
        }

        // GET: EventTypeManager/Details/5
        ...
        // GET: EventTypeManager/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: EventTypeManager/Create
        ...
        // POST: EventTypeManager/Delete/5
